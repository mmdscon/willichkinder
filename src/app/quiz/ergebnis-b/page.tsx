        ...
        <div className={`${sectionWidth} max-w-3xl mx-auto`}>
          <div className="text-center mb-10">
            ...
            >
              ...
              >
                In dir existieren gleichzeitig Pro- und Contra-Sehnsüchte. Es fehlt ein stabiler innerer Referenzpunkt – und das erzeugt emotionale Ambivalenz, keine äußere Drucksituation.
              </p>
              <div
          ...
          <div className="mb-12 space-y-4">
            ...
            {[
              {
                title: "Deine Ambivalenz ist kein Fehler",
                text: "Wenn du beide Lebensentwürfe als gleichwertig erlebst, zeigt das emotionale Tiefe und Selbstreflexion. Es bedeutet nicht, dass du dich nicht entscheiden kannst – sondern dass noch kein stabiler innerer Referenzpunkt entstanden ist.",
              },
              {
                title: "Die Lösung liegt nicht im Mehr-Nachdenken",
                text: "Je länger du analysierst, desto lauter werden beide Seiten. Was du brauchst, ist kein weiteres Argument – sondern einen inneren Raum, in dem du wieder spüren kannst, was wirklich zu dir gehört.",
              },
              {
                title: "Aus Ambivalenz kann echte Klarheit werden",
                text: "Mit der richtigen Begleitung lässt sich das innere Hin-und-Her auflösen. Nicht durch eine Entscheidung von außen – sondern durch einen tieferen Kontakt zu dem, was du wirklich willst.",
              },
            ].map((item) => (
              <div
                key={item.title}
